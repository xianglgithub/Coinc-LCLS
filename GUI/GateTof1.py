...
import Tof1GatedPlots, Tof1GatedPlots1D
   ...
   #     self.roiState = 0
    ...
    def sum_under_1d_roi(self):
       # print 'sum_linear i:',i
        ...
        self.parent.TofUi.Rect1Yield.setText(self.roiName+"Yield:%0.1f" % roi_yield)
...
#        print self.XYG_ind1, self.XYG_ind2 
    ...
    def initialize_plots(self):
        ...
        self.plotWindow = TofGPlots1()   
        self.plot1dWindow = TofGPlots1D1()           
...
class TofGPlots1D1(QtGui.QMainWindow):
    def __init__(self, parent=None):

        super(TofGPlots1D1, self).__init__()
        
        
        self.TofGPlots1DUi = Tof1GatedPlots1D.Ui_Tof1GatePlots1D()
...
class TofGPlots1(QtGui.QMainWindow):
    def __init__(self, parent=None):

        super(TofGPlots1, self).__init__()
        
        self.pos, self.colors = zip(*cmapToColormap(matplotlib.cm.jet))
        # Set the colormap
        self.clrmp =  pg.ColorMap(self.pos, self.colors)
        
        self.TofGPlotsUi = Tof1GatedPlots.Ui_Tof1GatedPlots()
