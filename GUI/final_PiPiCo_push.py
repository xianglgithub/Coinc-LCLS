...
# Form implementation generated from reading ui file 'final_PiPiCo_push.ui'
#
...
class Ui_PiPiCo(object):
    def setupUi(self, PiPiCo):
        PiPiCo.setObjectName(_fromUtf8("PiPiCo"))
        PiPiCo.resize(800, 600)
        self.centralwidget = QtGui.QWidget(PiPiCo)
        ...
        PiPiCo.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(PiPiCo)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 19))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        PiPiCo.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(PiPiCo)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        PiPiCo.setStatusBar(self.statusbar)

        self.retranslateUi(PiPiCo)
        QtCore.QMetaObject.connectSlotsByName(PiPiCo)

    def retranslateUi(self, PiPiCo):
        PiPiCo.setWindowTitle(_translate("PiPiCo", "PiPiCo", None))
        self.ARG1.setText(_translate("PiPiCo", "Add RectGate1", None))
        self.ARG2.setText(_translate("PiPiCo", "Add RectGate2", None))
        self.ARG3.setText(_translate("PiPiCo", "Add RectGate3", None))
        self.MousePosition.setText(_translate("PiPiCo", "MousePosition", None))
        self.RRG1.setText(_translate("PiPiCo", "Remove RectGate1", None))
        self.RRG2.setText(_translate("PiPiCo", "Remove RectGate2", None))
        self.RRG3.setText(_translate("PiPiCo", "Remove RectGate3", None))
        self.AndGate.setText(_translate("PiPiCo", "AndGate", None))
        self.Rect1Yield.setText(_translate("PiPiCo", "Rect1Yield", None))
        self.Rect2Yield.setText(_translate("PiPiCo", "Rect2Yield", None))
        self.Rect3Yield.setText(_translate("PiPiCo", "Rect3Yield", None))
        self.TotalYield.setText(_translate("PiPiCo", "TotalYield", None))
        self.Rect1Rate.setText(_translate("PiPiCo", "Rect1Rate", None))
        self.Rect2Rate.setText(_translate("PiPiCo", "Rect2Rate", None))
        self.Rect3Rate.setText(_translate("PiPiCo", "Rect3Rate", None))
        self.TotalRate.setText(_translate("PiPiCo", "TotalRate", None))
