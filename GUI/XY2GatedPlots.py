...
# Form implementation generated from reading ui file 'XY2GatedPlots.ui'
#
...
class Ui_XY2GatedPlots(object):
    def setupUi(self, XY2GatedPlots):
        XY2GatedPlots.setObjectName(_fromUtf8("XY2GatedPlots"))
        XY2GatedPlots.resize(800, 600)
        self.centralwidget = QtGui.QWidget(XY2GatedPlots)
        ...
        XY2GatedPlots.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(XY2GatedPlots)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 19))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        XY2GatedPlots.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(XY2GatedPlots)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        XY2GatedPlots.setStatusBar(self.statusbar)

        self.retranslateUi(XY2GatedPlots)
        QtCore.QMetaObject.connectSlotsByName(XY2GatedPlots)

    def retranslateUi(self, XY2GatedPlots):
        XY2GatedPlots.setWindowTitle(_translate("XY2GatedPlots", "XY2GatedPlots", None))
