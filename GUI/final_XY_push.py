...
# Form implementation generated from reading ui file 'final_XY_push.ui'
#
...
class Ui_XY(object):
    ...
    def retranslateUi(self, XY):
        ...
        self.ARG3.setText(_translate("XY", "Add RectGate3", None))
        ...
        self.RRG3.setText(_translate("XY", "Remove RectGate3", None))
        ...
        self.Rect3Yield.setText(_translate("XY", "Rect3Yield", None))
        ...
        self.Rect3Rate.setText(_translate("XY", "Rect3Rate", None))
