...
import Tof2GatedPlots, Tof2GatedPlots1D
#from GUIs import XYGPlots1, XYGTof2
...
class GateTof2():
    ...
    def sum_under_1d_roi(self):
       # print 'sum_linear i:',i
        ...
        self.parent.TofUi.Rect2Yield.setText(self.roiName+"Yield:%0.1f" % roi_yield)
    #    print roi_yield
...
#        print self.XYG_ind1, self.XYG_ind2 
    ...
    def initialize_plots(self):
        ...
        self.plotWindow = TofGPlots2()   
        self.plot1dWindow = TofGPlots1D2()           
...
class TofGPlots1D2(QtGui.QMainWindow):
    def __init__(self, parent=None):

        super(TofGPlots1D2, self).__init__()
        
        
        self.TofGPlots1DUi = Tof2GatedPlots1D.Ui_Tof2GatedPlots1D()
...
class TofGPlots2(QtGui.QMainWindow):
    def __init__(self, parent=None):
