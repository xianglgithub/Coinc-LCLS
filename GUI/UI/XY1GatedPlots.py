...
# Form implementation generated from reading ui file 'XY1GatedPlots.ui'
#
...
class Ui_XY1GatedPlots(object):
    def setupUi(self, XY1GatedPlots):
        XY1GatedPlots.setObjectName(_fromUtf8("XY1GatedPlots"))
        XY1GatedPlots.resize(800, 600)
        self.centralwidget = QtGui.QWidget(XY1GatedPlots)
        ...
        XY1GatedPlots.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(XY1GatedPlots)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 19))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        XY1GatedPlots.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(XY1GatedPlots)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        XY1GatedPlots.setStatusBar(self.statusbar)

        self.retranslateUi(XY1GatedPlots)
        QtCore.QMetaObject.connectSlotsByName(XY1GatedPlots)

    def retranslateUi(self, XY1GatedPlots):
        XY1GatedPlots.setWindowTitle(_translate("XY1GatedPlots", "XY1GatedPlots", None))
