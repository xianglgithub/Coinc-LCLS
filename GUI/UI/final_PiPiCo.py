...
# Form implementation generated from reading ui file 'final_PiPiCo.ui'
#
...
class Ui_PiPiCo(object):
    ...
    def retranslateUi(self, PiPiCo):
        ...
        self.RectGate.setText(_translate("PiPiCo", "RectGate", None))
        self.CircleGate1.setText(_translate("PiPiCo", "CircleGate1", None))
        self.CircleGate2.setText(_translate("PiPiCo", "CircleGate2", None))
        self.MousePosition.setText(_translate("PiPiCo", "MousePosition", None))
        self.RectYield.setText(_translate("PiPiCo", "RectYield", None))
        self.Circle1Yield.setText(_translate("PiPiCo", "Circle1Yield", None))
        self.Circle2Yield.setText(_translate("PiPiCo", "Circle2Yield", None))
        self.TotalYield.setText(_translate("PiPiCo", "TotalYield", None))
        self.RectRate.setText(_translate("PiPiCo", "RectRate", None))
        self.Circle1Rate.setText(_translate("PiPiCo", "Circle1Rate", None))
        self.Circle2Rate.setText(_translate("PiPiCo", "Circle2Rate", None))
