...
# Form implementation generated from reading ui file 'XY3GatedPlots.ui'
#
...
class Ui_XY3GatedPlots(object):
    def setupUi(self, XY3GatedPlots):
        XY3GatedPlots.setObjectName(_fromUtf8("XY3GatedPlots"))
        XY3GatedPlots.resize(800, 600)
        self.centralwidget = QtGui.QWidget(XY3GatedPlots)
        ...
        XY3GatedPlots.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(XY3GatedPlots)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 19))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        XY3GatedPlots.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(XY3GatedPlots)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        XY3GatedPlots.setStatusBar(self.statusbar)

        self.retranslateUi(XY3GatedPlots)
        QtCore.QMetaObject.connectSlotsByName(XY3GatedPlots)

    def retranslateUi(self, XY3GatedPlots):
        XY3GatedPlots.setWindowTitle(_translate("XY3GatedPlots", "XY3GatedPlots", None))
