...
# Form implementation generated from reading ui file 'final_eAR_push.ui'
#
...
class Ui_eAR(object):
    def setupUi(self, eAR):
        eAR.setObjectName(_fromUtf8("eAR"))
        eAR.resize(800, 600)
        self.centralwidget = QtGui.QWidget(eAR)
        ...
        eAR.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(eAR)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 19))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        eAR.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(eAR)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        eAR.setStatusBar(self.statusbar)

        self.retranslateUi(eAR)
        QtCore.QMetaObject.connectSlotsByName(eAR)

    def retranslateUi(self, eAR):
        eAR.setWindowTitle(_translate("eAR", "eAR", None))
        self.ARG1.setText(_translate("eAR", "Add RectGate1", None))
        self.ARG2.setText(_translate("eAR", "Add RectGate2", None))
        self.ARG3.setText(_translate("eAR", "Add RectGate3", None))
        self.MousePosition.setText(_translate("eAR", "MousePosition", None))
        self.RRG1.setText(_translate("eAR", "Remove RectGate1", None))
        self.RRG2.setText(_translate("eAR", "Remove RectGate2", None))
        self.RRG3.setText(_translate("eAR", "Remove RectGate3", None))
        self.AndGate.setText(_translate("eAR", "AndGate", None))
        self.Rect1Yield.setText(_translate("eAR", "Rect1Yield", None))
        self.Rect2Yield.setText(_translate("eAR", "Rect2Yield", None))
        self.Rect3Yield.setText(_translate("eAR", "Rect3Yield", None))
        self.TotalYield.setText(_translate("eAR", "TotalYield", None))
        self.Rect1Rate.setText(_translate("eAR", "Rect1Rate", None))
        self.Rect2Rate.setText(_translate("eAR", "Rect2Rate", None))
        self.Rect3Rate.setText(_translate("eAR", "Rect3Rate", None))
        self.TotalRate.setText(_translate("eAR", "TotalRate", None))
