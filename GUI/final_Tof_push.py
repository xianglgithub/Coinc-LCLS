...
# Form implementation generated from reading ui file 'final_Tof_push.ui'
#
...
class Ui_Tof(object):
    ...
    def retranslateUi(self, Tof):
        ...
        self.ARG1.setText(_translate("Tof", "Add RectGate1", None))
        self.ARG2.setText(_translate("Tof", "Add RectGate2", None))
        self.ARG3.setText(_translate("Tof", "Add RectGate3", None))
        self.MousePosition.setText(_translate("Tof", "MousePosition", None))
        self.RRG1.setText(_translate("Tof", "Remove RectGate1", None))
        self.RRG2.setText(_translate("Tof", "Remove RectGate2", None))
        self.RRG3.setText(_translate("Tof", "Remove RectGate3", None))
        self.AndGate.setText(_translate("Tof", "AndGate", None))
        self.Rect1Yield.setText(_translate("Tof", "Rect1Yield", None))
        self.Rect2Yield.setText(_translate("Tof", "Rect2Yield", None))
        self.Rect3Yield.setText(_translate("Tof", "Rect3Yield", None))
        self.TotalYield.setText(_translate("Tof", "TotalYield", None))
        self.Rect1Rate.setText(_translate("Tof", "Rect1Rate", None))
        self.Rect2Rate.setText(_translate("Tof", "Rect2Rate", None))
        self.Rect3Rate.setText(_translate("Tof", "Rect3Rate", None))
