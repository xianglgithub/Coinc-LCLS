...
# Form implementation generated from reading ui file 'final_eR_push.ui'
#
...
class Ui_eR(object):
    def setupUi(self, eR):
        eR.setObjectName(_fromUtf8("eR"))
        eR.resize(800, 600)
        self.centralwidget = QtGui.QWidget(eR)
        ...
        eR.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(eR)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 19))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        eR.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(eR)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        eR.setStatusBar(self.statusbar)

        self.retranslateUi(eR)
        QtCore.QMetaObject.connectSlotsByName(eR)

    def retranslateUi(self, eR):
        eR.setWindowTitle(_translate("eR", "eR", None))
        self.ARG1.setText(_translate("eR", "Add RectGate1", None))
        self.ARG2.setText(_translate("eR", "Add RectGate2", None))
        self.ARG3.setText(_translate("eR", "Add RectGate3", None))
        self.MousePosition.setText(_translate("eR", "MousePosition", None))
        self.RRG1.setText(_translate("eR", "Remove RectGate1", None))
        self.RRG2.setText(_translate("eR", "Remove RectGate2", None))
        self.RRG3.setText(_translate("eR", "Remove RectGate3", None))
        self.AndGate.setText(_translate("eR", "AndGate", None))
        self.Rect1Yield.setText(_translate("eR", "Rect1Yield", None))
        self.Rect2Yield.setText(_translate("eR", "Rect2Yield", None))
        self.Rect3Yield.setText(_translate("eR", "Rect3Yield", None))
        self.TotalYield.setText(_translate("eR", "TotalYield", None))
        self.Rect1Rate.setText(_translate("eR", "Rect1Rate", None))
        self.Rect2Rate.setText(_translate("eR", "Rect2Rate", None))
        self.Rect3Rate.setText(_translate("eR", "Rect3Rate", None))
        self.TotalRate.setText(_translate("eR", "TotalRate", None))
