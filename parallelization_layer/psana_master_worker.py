#    This file is part of OnDA with few changes.
...
#                if self.acqiris_data_wf is None or self.eImage is None or self.pulse_eng is None or self.photon_eng is None:
                if self.acqiris_data_wf is None:
